...
export const SELECTORS = {
  loginFormReady: 'span[_ngcontent-my-app-id-c173=""]',
  passwordTab: 'span[_ngcontent-my-app-id-c173=""]',
  usernameField: '[formcontrolname="username"]',
  passwordField: '[formcontrolname="password"]',
  loginButton: 'button[_ngcontent-my-app-id-c168=""]',
  dashboard: '.only-card-wrapper > :first-child',
  closePopup: '#close-popup',
  downloadExcel: 'span.download-excel',
};

const CARD_BASE = 'div.card.card-box.card-box-url.ng-star-inserted[_ngcontent-my-app-id-c130][appgtm]';
